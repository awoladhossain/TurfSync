...
`সাধারণত কী হয়`: ইন্টারনেট বা নেটওয়ার্কে ডেটা যখন এক জায়গা থেকে অন্য জায়গায় যায়, তখন সে ছোট ছোট প্যাকেটে ভাগ হয়ে যায়। এনগিন্স যদি প্রতিটা ছোট ছোট ডেটার টুকরো বা রেসপন্স তৈরি হওয়ামাত্রই আলাদা আলাদা প্যাকেটে ইন্টারনেটে পাঠাতে থাকে, তবে নেটওয়ার্কেHeader-এর জ্যাম তৈরি হয় এবং ব্যান্ডউইথ নষ্ট হয়।
...
পরবর্তীতে `proxy_pass http://turfbook_app;` ব্যবহার করে request এই backend group-এ পাঠানো হবে। সহজ কথা: তুই এনগিন্সের ভেতর একটা কাল্পনিক "গ্রুপ" বা "টার্গেট জোন" বানাচ্ছিস যার নাম দিলি turfbook_app।
